...
//To print the Max element in given Array//
//******************************************
 ...
 public static void main(String[]args)
{
    ...
    System.out.println("Show the max element");
    int max=0;
    for (int i=0;i<a.length;i++)
    {
      if (max<a[i])
...
//To print the Min element in given Array//
//*****************************************
...
class min_element
{
  public static void main(String[]args)
  {
    ...
    for (int i=0;i<a.length;i++)
    {
     ...
     System.out.println("Show the min element");
    int min=a[0];
    for (int i=0;i<a.length;i++)
    {
      if (min>a[i])
...
//To print the 2nd max element in given Array//
//************************************************
...
class secound_max
{
  public static void main(String[]args)
  {
    ...
    System.out.println("Show the 2md max");
    int fmax=0;
    for (int i=0;i<a.length;i++)
    {
     if (fmax<a[i])
...
//To print the 2nd min element in given Array//
//*********************************************
 ...
 class count_of_even
 {
   public static void main(String[]args)
   {
    ...
    for (int i=0;i<a.length;i++)
    {
     ...
     System.out.println("Show the count of even no");
      int count=0;
     for (int i=0;i<a.length;i++)
     {
       if (a[i]%2==0)
...
//6 ) Create a int type array and store element print count of odd no
//*****************************************************************//
 /*
import java.util.Scanner;
 class count_of_odd
 {
   public static void main(String[]args)
   {
    ...
    for (int i=0;i<a.length;i++)
    {
     ...
     System.out.println("Show the count of odd no");
      int count=0;
     for (int i=0;i<a.length;i++)
     {
       if (a[i]%2!=0)
...
//7)create a floate type array store the element print data in int type
//*******************************************************************
/*
import java.util.Scanner;
class floate_convert_into_int
{
 public static void main(String[]args)
 {
	Scanner sc=new Scanner(System.in);
...
//8)create the character type array and store element print only vowels//
//**********************************************************************
/*
import java.util.Scanner;
class only_vowels
...
//9)create the character type array and store element print only consonant//
//*************************************************************************
...
class only_consonat
{
 public static void main(String []args)
 {
    ...
    for (int i=0;i<c1.length;i++)
    {
     ...
     System.out.println("Show all consonat charatar");
    for (int i=0;i<c1.length;i++)
    {
    if (c1[i]!='a' && c1[i]!='e' && c1[i]!='i'&& c1[i]!='o' && c1[i]!='u' && c1[i]!='A' && c1[i]!='E' && c1[i]!='I' && c1[i]!='O' && c1[i]!='U')
      {
...
//10)Create a character type array and store element print count of vowels//
//***********************************************************************
/*import java.util.Scanner;
class count_vowels
{
 public static void main(String[]args)
  {
    ...
    System.out.println("Show count the vowels charachater");
    int count=0;
    for (int i=0;i<c1.length;i++)
    {
     if (c1[i]=='a' || c1[i]=='e' || c1[i]=='i' || c1[i]=='o' || c1[i]=='u' || c1[i]=='A' || c1[i]=='E' || c1[i]=='I' || c1[i]=='O' || c1[i]=='U')
...
//11)Create a character type array and store element print count of consonat//
//***********************************************************************
/*import java.util.Scanner;
class count_consonat
{
 public static void main(String []args)
 {
	Scanner sc=new Scanner(System.in);
    ...
    for (int i=0;i<c1.length;i++)
    {
     System.out.println("Enter the chararater");
     c1[i]=sc.next().charAt(0);
    }
    System.out.println("Show the count of consonat");
    int count=0;
    for (int i=0;i<c1.length;i++)
    {
      if (c1[i]!='a' && c1[i]!='e' && c1[i]!='i' && c1[i]!='o' && c1[i]!='u' &&
